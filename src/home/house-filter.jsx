        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
            ...
            <label className="flex flex-col">
                ...
                <input type="text" name="location"
                    className="px-3 w-full py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white" placeholder="Enter location" />
            </label>
